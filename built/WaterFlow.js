...
var WaterFlow = function (props, ref) {
    ...
    /**
     * 上拉加载,传入一个Promise回调,请求完成后才允许再次触发回调
     * 如果回调不为一个Promise对象,则不做拦截处理
     */
    ...
    return (<Columns_1.default {...props} ref={WaterflowRef} columnFlatListProps={props.columnFlatListProps} columnsFlatListProps={props.columnsFlatListProps} numColumns={props.numColumns} data={data} heightForItem={props.heightForItem} onEndReached={onEndReached} keyForItem={props.keyForItem} renderItem={props.renderItem}/>);
};
